...
HD_PWD='C:/Users/Lenovo/Desktop/ticket_price/ticket_price.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ticket_price_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ticket_price_top.tcl
