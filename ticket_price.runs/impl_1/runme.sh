...
HD_PWD='C:/Users/Lenovo/Desktop/ticket_price/ticket_price.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ticket_price_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ticket_price_top.tcl -notrace
